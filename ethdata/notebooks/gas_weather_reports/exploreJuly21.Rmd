...
The data includes all blocks produced between July 21st, 2020, 02:00:17 UTC and July 27th, 2020, 06:37:09 UTC. It was obtained from [Geth](https://geth.ethereum.org/) using a [DAppNode](https://dappnode.io) full node with the wonderful [ethereum-etl](https://github.com/blockchain-etl/ethereum-etl) package from Evgeny Medvedev to extract transaction and block details.

<aside>
You can check the source for this notebook [here (R notebook)](https://github.com/ethereum/rig/tree/master/ethdata/notebooks/gas_weather_reports/exploreJuly21.Rmd).
</aside>
...
The two averages are mighty close to each other, with big blocks posting even slightly higher gas prices than small one (a negligible difference however).