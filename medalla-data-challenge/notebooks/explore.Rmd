...
Since we expect validators to broadly agree in times of low latency, we also expect that a lot of individual attestations will share these same four attributes. We can aggregate such a set of individual attestations $I$ into a single, aggregate, attestation.
